...
mpu6050_data_t *mpu6050_get_raw_data ( void )
{
    return (mpu6050_data_t *)(&raw_gyr_acc);
}
...
bool mpu6050_test_connection( void )
{
    ...
    for ( iTries = 0; iTries < MAX_CONNECT_ATTEMPTS; iTries++ ) {
        ...
        // dbgprintf( "[%s]: Test connection result: 0x%x\n", __FUNCTION__, result );
...
void mpu6050_calibration ( void )
{
    ...
    dbgprintf( "\nCalculating offsets...\n" );
    {
        ...
        while (1)
        {
            ...
            dbgprintf( "Reading data... %d / 6\n", ready );
            // dbgprintf( "Data: %d / %d / %d\n", mean_ax, mean_ay, mean_az );
